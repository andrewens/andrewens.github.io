...
While researching the optimized n-body gravity simulations for my Ship Crew RPG game, I had to implement a quadtree / octree data structure so that I could implement the [Barnes-Hut algorithm](https://jheer.github.io/barnes-hut/).
